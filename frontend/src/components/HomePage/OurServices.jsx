    ...
    <section className='mx-auto md:w-[80%] py-10'>
        ...
        <article className="grid grid-cols-3 gap-4 w-full h-full">
            ...
            <div className="flex flex-col space-y-4">
                <div className='bg-lightDark border-4 border-black p-1 rounded-xl h-full shadow-2xl card  '>
                    <div className="bg-dark p-6 rounded-lg shadow-2xl h-full card-content">
                        <h3 className="text-lg font-bold text-primary mb-2">Cloud Certification Training</h3>
                        <p className="text-gray-300">
                            Prepare for AWS, Azure, and Google Cloud certifications with expert-led courses and hands-on labs.
                        </p>
                    </div>
                </div>
                <div className='bg-lightDark border-4 border-black p-1 rounded-xl h-full shadow-2xl '>
                    <div className="bg-dark p-6 rounded-lg shadow-md h-full -content">
            ...
            <div className="flex items-center justify-center h-full bg-lightDark border-4 border-black p-1 rounded-xl shadow-2xl ">
                <div className="bg-dark text-white p-8 rounded-lg shadow-md w-full h-[60vh] -content">
                    <h2 className="text-2xl font-bold mb-4">Hands-on Cloud Labs</h2>
                    <p className="text-gray-300">
            ...
            <div className="flex flex-col space-y-4">
                <div className='bg-lightDark border-4 border-black p-1 rounded-xl shadow-2xl h-full  '>
                    <div className="bg-dark p-6 rounded-lg shadow-md h-full -content">
