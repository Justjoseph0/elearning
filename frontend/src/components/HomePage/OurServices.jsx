...
const OurServices = () => {
  return (
    <section className='mx-auto md:w-[80%] py-10'>
        <h2 className='text-3xl text-center font-bold text-primary mb-6'>Our Services</h2>
        <article className="grid grid-cols-3 gap-4 w-full h-full">
            {/* Left Side - 2 Smaller Grid Items */}
            <div className="flex flex-col space-y-4">
                <div className='bg-lightDark border-4 border-black p-1 rounded-xl h-full shadow-2xl card relative'>
                ...
                <div className='bg-lightDark border-4 border-black p-1 rounded-xl h-full shadow-2xl card'>
                    <div className="bg-dark p-6 rounded-lg shadow-md h-full card-content">
                        <h3 className="text-lg font-bold text-primary mb-2">Live Instructor-Led Classes</h3>
                        <p className="text-gray-300">
            ...
            <div className="flex flex-col space-y-4">
                <div className='bg-lightDark border-4 border-black p-1 rounded-xl shadow-2xl h-full card '>
                    <div className="bg-dark p-6 rounded-lg shadow-md h-full card-content">
                        <h3 className="text-lg font-bold text-primary mb-2">Career Guidance & Mentorship</h3>
                        <p className="text-gray-300">
                ...
                <div className='bg-lightDark border-4 border-black p-1 rounded-xl shadow-2xl h-full card'>
                    <div className="bg-dark p-6 rounded-lg shadow-md h-full card-content">
                        <h3 className="text-lg font-bold text-primary mb-2">Exclusive Cloud Community</h3>
                        <p className="text-gray-300">
